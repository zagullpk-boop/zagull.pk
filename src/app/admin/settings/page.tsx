                ...
                <div className="space-y-6">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-sans">
                      ...
                      <div className="space-y-2">
                         ...
                         <Input defaultValue="info@zagull.pk" className="bg-gray-50/50 border-border-light" />
                      </div>
                      <div className="space-y-2">
                         <label className="text-[10px] font-bold text-text-secondary uppercase tracking-widest">WhatsApp Number</label>
                         <Input defaultValue="+92 300 1234567" className="bg-gray-50/50 border-border-light" />
                      </div>
                   </div>
                   ...
                   <div className="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-border-light group">
                      <div className="flex items-center gap-4">
                         ...
                         <div>
                            ...
                            <p className="text-[10px] text-text-secondary">info@zagull.pk • Super Admin</p>
                         </div>
                      </div>
