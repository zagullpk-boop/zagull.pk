            ...
            <div className="lg:col-span-2">
              {currentStep === "shipping" && (
                <div className="bg-white p-8 md:p-12 rounded-3xl border border-border-light shadow-sm space-y-10 animate-in fade-in slide-in-from-left-4 duration-500">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2 md:col-span-2">
                      <label className="text-xs font-bold uppercase tracking-widest text-text-secondary">Order Notes (Optional)</label>
                      <Input name="orderNotes" value={formData.orderNotes} onChange={handleChange} placeholder="Special instructions for delivery..." className="h-12" />
                    </div>
                  </div>
              ...
              {currentStep === "payment" && (
                <div className="bg-white p-8 md:p-12 rounded-3xl border border-border-light shadow-sm space-y-10 animate-in fade-in slide-in-from-left-4 duration-500">
                  ...
                  <div className="space-y-4">
                    <div className="w-full p-6 border-2 border-accent-forest bg-background-primary flex items-center justify-between rounded-2xl transition-all">
                    ...
                    <p className="text-xs text-text-secondary italic px-2">
                      * We currently only support Cash on Delivery to ensure the best service across Pakistan.
                    </p>
                  </div>
                ...
                <div className="bg-white p-8 md:p-12 rounded-3xl border border-border-light shadow-sm text-center space-y-8 animate-in zoom-in duration-500">
                  ...
                  <div className="space-y-4 pt-4">
                    <p className="text-sm text-text-secondary">
                      To speed up your order, please send your order summary to us on WhatsApp:
                    </p>
                    <a 
                      href={`https://wa.me/923329024005?text=${encodeURIComponent(
                        `*New Order from ZAGULL.PK*\n\n` +
                      ...
                      className="inline-flex items-center justify-center gap-3 w-full max-w-sm bg-[#25D366] text-white py-4 rounded-2xl font-bold transition-all hover:bg-[#128C7E] shadow-lg shadow-[#25D366]/20"
                    >
                  ...
                  <Link href="/shop" className="inline-block pt-4">
                    <Button variant="outline" size="lg" className="px-12">Back to Collections</Button>
                  </Link>
                </div>
              )}
            </div>
