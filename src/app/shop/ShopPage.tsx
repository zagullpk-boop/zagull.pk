...
import { Search, SlidersHorizontal, ChevronDown, X, ChevronRight, Loader2, ShoppingBag } from "lucide-react";
...
function ShopContent() {
  ...
  const subCategories = activeCategory === "Jewellery" 
    ...
    : activeCategory === "Gift Baskets"
    ? ["Corporate", "Weddings", "Birthdays", "Eid Special"]
    : [];
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="text-center py-32 space-y-6 bg-white/50 rounded-3xl border border-dashed border-border-light">
                  <div className="w-20 h-20 bg-background-primary rounded-full flex items-center justify-center mx-auto">
                    <ShoppingBag className="w-8 h-8 text-accent-forest opacity-20" />
                  </div>
                  <div className="space-y-2">
                    <p className="text-2xl font-serif text-text-primary">New arrivals coming soon</p>
                    <p className="text-text-secondary max-w-xs mx-auto">check back shortly!</p>
                  </div>
                  <Button 
